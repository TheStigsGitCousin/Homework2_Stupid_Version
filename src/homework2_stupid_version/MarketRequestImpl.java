...
public class MarketRequestImpl extends UnicastRemoteObject implements MarketRequest{
    ...
    private final Map<String, Item> uploadedItems=new HashMap<>();
    ...
    public Message SellItem(Item item) throws RemoteException {
        ...
        synchronized(uploadedItems){
            uploadedItems.put(item.getName()+Float.toString(item.getPrice()), item);
    ...
    @Override
    public Message BuyItem(Item item, Owner buyer) throws RemoteException {
            ...
            if(item!=null){
                ...
                if(owner!=null){
                    ...
                    if(successful){
                        ...
                        uploadedItems.remove(item.getName()+Float.toString(item.getPrice()));
                        owner.itemSold(item);
                    }
                }
            }else{
